...
from utils.SV_gen_utils import compute_sv

__all__ = ['FlyingThings3DSubset_Supervoxel']


class FlyingThings3DSubset_Supervoxel(data.Dataset):
    """
    Args:
    ...
    def __getitem__(self, index):
        pc1_loaded, pc2_loaded, voxel_list = self.pc_loader(self.samples[index])
        ...
        pc1_transformed, pc2_transformed, sf_transformed, voxel_list_transformed = \
            self.transform([pc1_loaded, pc2_loaded, voxel_list, self.num_supervoxels])
        ...
        return pc1_transformed, pc2_transformed, pc1_norm, pc2_norm, \
               sf_transformed, voxel_list_transformed, self.samples[index]
